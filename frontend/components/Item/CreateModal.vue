    ...
    <DialogContent>
      ...
      <form class="flex flex-col gap-2" @submit.prevent="create()">
        ...
        <div
          ...
          class="mt-4 border-t border-gray-300 px-4 pb-4"
        >
          <div v-for="(photo, index) in form.photos" :key="index">
            ...
            <p class="mt-1 text-sm" style="overflow-wrap: anywhere">
      ...
      <DialogFooter>
        <span class="flex items-center gap-1 text-sm">
          Use <Shortcut size="sm" :keys="['Shift']" /> +
