...
| HBOX_LABEL_MAKER_HEIGHT                 | height for generated labels in pixels                                                                                                                                                     | 200                                                                                            |
...
| HBOX_LABEL_MAKER_LABEL_SERVICE_URL      | URL to an external service to generate and return a label. Expected to return a PDF File. See [External Label Service](/en/advanced/external-label-service) for more information          |                                                                                                |
