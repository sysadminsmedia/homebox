...
This mirrors [`SECURITY.md`](https://github.com/sysadminsmedia/homebox/blob/main/SECURITY.md) in the
repository. If the two ever disagree, the file in the repository is authoritative.
