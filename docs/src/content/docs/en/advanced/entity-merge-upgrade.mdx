...
> [!NOTE]
> The current `:latest` Docker image still uses the legacy API. Legacy API documentation is available at https://redocly.github.io/redoc/?url=https://hay-kot.github.io/homebox/api/openapi-2.0.json.
