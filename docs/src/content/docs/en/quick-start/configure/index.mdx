...
| HBOX_BARCODE_OPENFOODFACTS_CONTACT      |                                                                                                | Optional contact value included in the User-Agent for Open Food Facts, Open Beauty Facts, and Open Products Facts barcode lookups.                                                         |
