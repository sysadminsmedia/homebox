...
| HBOX_LABEL_MAKER_HIDE_LOCATION          | false                                                                                          | hide the location line on item and asset labels                                                                                                                                           |
| HBOX_LABEL_MAKER_HIDE_ASSET_ID          | false                                                                                          | hide the asset ID on asset labels; the item name is shown as the bold headline instead                                                                                                    |
