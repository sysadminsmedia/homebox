...
| HBOX_WEB_MAX_IMPORT_SIZE                | 1024                                                                                           | maximum collection-restore upload size in MB (set separately from uploads, since a full backup with attachments is much larger)                                                           |
| HBOX_WEB_MAX_PARSE_MEMORY               | 64                                                                                             | memory in MB used to parse multipart forms; data beyond this spills to temp files                                                                                                         |
