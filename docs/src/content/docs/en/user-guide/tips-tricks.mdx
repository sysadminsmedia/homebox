...
Homebox uses [shoutrrr](https://shoutrrr.nickfedor.com/) to send notifications. This allows you to send notifications to a variety of services including Discord, Slack, IFTTT, generic webhooks, and SMTP-based email.
...
For the full list of services and how to configure the service URL, refer to the [Services Overview](https://shoutrrr.nickfedor.com/latest/services/overview/) in shoutrrr's documentation.
