...
// testCtx returns a privacy-bypassing system context. The services test
// suite validates business logic; ORM-level authorization has its own
// enforcement suite that builds real viewer contexts.
