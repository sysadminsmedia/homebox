...
-- the underlying timestamptz type — purchase_date and sold_date remain
-- timestamptz after this migration runs. Date-only semantics are enforced
-- by the Go layer (internal/data/types.Date), which truncates to YYYY-MM-DD
