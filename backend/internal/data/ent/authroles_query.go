...
func (_q *AuthRolesQuery) prepareQuery(ctx context.Context) error {
	...
	if authroles.Policy == nil {
		return errors.New("ent: uninitialized authroles.Policy (forgotten import ent/runtime?)")
	}
	if err := authroles.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *AuthRolesQuery) ForUpdate(opts ...sql.LockOption) *AuthRolesQuery {
...
func (_q *AuthRolesQuery) ForShare(opts ...sql.LockOption) *AuthRolesQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
