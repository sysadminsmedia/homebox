...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldName, user.FieldEmail, user.FieldPassword, user.FieldRole, user.FieldAuthProvider, user.FieldExternalID:
...
func (_m *User) String() string {
	...
	builder.WriteString(_m.AuthProvider)
	builder.WriteString(", ")
