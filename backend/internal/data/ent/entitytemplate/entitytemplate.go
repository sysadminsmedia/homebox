...
const (
	// Label holds the string label denoting the entitytemplate type in the database.
	...
	GroupTable = "entity_templates"
	// GroupInverseTable is the table name for the Group entity.
	// It exists in this package in order to avoid circular dependency with the "group" package.
	GroupInverseTable = "groups"
	// GroupColumn is the table column denoting the group relation/edge.
	GroupColumn = "group_entity_templates"
	...
	FieldsColumn = "entity_template_fields"
	// LocationTable is the table that holds the location relation/edge.
	LocationTable = "entity_templates"
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "entity_templates"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"entity_template_location",
	"group_entity_templates",
}
...
var (
	...
	DefaultDefaultQuantity float64
...
// OrderOption defines the ordering options for the EntityTemplate queries.
