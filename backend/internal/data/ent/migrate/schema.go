...
var (
	...
	ItemsColumns = []*schema.Column{
		...
		{Name: "last_inventory_at", Type: field.TypeTime, Nullable: true},
		{Name: "cable_length", Type: field.TypeFloat64, Nullable: true},
		{Name: "cable_length_unit", Type: field.TypeEnum, Nullable: true, Enums: []string{"m", "ft", "cm"}},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "role", Type: field.TypeEnum, Enums: []string{"viewer", "user", "manager", "owner"}, Default: "user"},
