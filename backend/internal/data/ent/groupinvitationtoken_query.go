...
func (_q *GroupInvitationTokenQuery) prepareQuery(ctx context.Context) error {
	...
	if groupinvitationtoken.Policy == nil {
		return errors.New("ent: uninitialized groupinvitationtoken.Policy (forgotten import ent/runtime?)")
	}
	if err := groupinvitationtoken.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *GroupInvitationTokenQuery) ForUpdate(opts ...sql.LockOption) *GroupInvitationTokenQuery {
...
func (_q *GroupInvitationTokenQuery) ForShare(opts ...sql.LockOption) *GroupInvitationTokenQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
