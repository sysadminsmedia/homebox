...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.Group, c.GroupInvitationToken, c.ItemTemplate, c.MaintenanceEntry,
...
func (c *ItemTemplateClient) QueryLocation(_m *ItemTemplate) *EntityQuery {
	query := (&EntityClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
type (
	hooks struct {
		...
		GroupInvitationToken, ItemTemplate, MaintenanceEntry, Notifier, Tag,
