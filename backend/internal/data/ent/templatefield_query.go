...
func (_q *TemplateFieldQuery) prepareQuery(ctx context.Context) error {
	...
	if templatefield.Policy == nil {
		return errors.New("ent: uninitialized templatefield.Policy (forgotten import ent/runtime?)")
	}
	if err := templatefield.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *TemplateFieldQuery) ForUpdate(opts ...sql.LockOption) *TemplateFieldQuery {
...
func (_q *TemplateFieldQuery) ForShare(opts ...sql.LockOption) *TemplateFieldQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
