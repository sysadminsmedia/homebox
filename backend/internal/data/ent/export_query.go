...
func (_q *ExportQuery) prepareQuery(ctx context.Context) error {
	...
	if export.Policy == nil {
		return errors.New("ent: uninitialized export.Policy (forgotten import ent/runtime?)")
	}
...
func (_q *ExportQuery) ForUpdate(opts ...sql.LockOption) *ExportQuery {
...
func (_q *ExportQuery) ForShare(opts ...sql.LockOption) *ExportQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
